...
public class Demo {
    public static void main(String[] args)throws Exception {
        ...
        Transaction transaction1 = new Transaction(1,"Kiev",5,"popolnenie scheta mob",
                TransactionType.INCOME, new Date());
        Transaction transaction2 = new Transaction(2,"Odessa",10,"popolnenie scheta mob",
                TransactionType.INCOME, new Date());
        Transaction transaction3 = new Transaction(5,"Kiev",40,"popolnenie scheta mob",
                TransactionType.OUTCOME, new Date());
        Transaction transaction4= new Transaction(0,"Odessa",2,"popolnenie scheta mob",
                TransactionType.OUTCOME, new Date());
        Transaction transaction5= new Transaction(15,"Odessa",3,"popolnenie scheta mob",
                TransactionType.OUTCOME, new Date());
